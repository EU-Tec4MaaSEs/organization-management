...
class CapabilityControllerTest {
    ...
    void testGetAllCapabilities_success() throws Exception {
        CapabilityEntry cap1 = new CapabilityEntry("Milling", "Primary", true, "High precision", List.of(), null, null, null, null, null);
        CapabilityEntry cap2 = new CapabilityEntry("Drilling", "Secondary", true, "Automated", List.of(), null, null, null, null, null);
